...
> ⚠️ 이 표의 **상태 칸은 원래 계획 기준선**(대부분 `대기`)이며 실제 진행과 다르다.
> **현재 실제 상태·게이트 판정·Go/No-Go는 [[docs/status-and-go-no-go]] 참조** (2026-06-15 기준:
> MVP 코드/8주 품질 게이트 사실상 달성, 파일럿은 조직·인프라 결정 대기).
