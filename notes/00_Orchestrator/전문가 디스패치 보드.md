...
| 디스패치 | 담당 전문가 | 상태 | 증거 |
|---|---|---|---|
| Sprint 0 metadata API contract test | Backend + QA | 시작 | `apps/api/tests/test_metadata_contracts.py` |
| Synthetic corpus v0.1 | RAG + Security + QA | 시작 | `eval/synthetic-corpus/cases-v0.1.json` |
| Compose smoke | DevOps/MLOps | 시작 | `tools/smoke/compose-smoke.ps1` |
| Agent Studio route smoke | Frontend + QA | 시작 | `apps/web/tests/smoke.spec.ts` |
